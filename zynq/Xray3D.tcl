...
#
# Xray3D.tcl: Tcl script for re-creating project 'project_Xray3D'
#
# Generated by Vivado on Thu Jun 29 11:54:53 CST 2023
...
#
# 1. This project restoration tcl script (Xray3D.tcl) that was generated.
#
...
set _xil_proj_name_ "project_Xray3D"
...
if { $obj != {} } {
   set_property "ip_repo_paths" "[file normalize "$origin_dir/../../../hls_project/Xray3D/ip"]" $obj
...
proc cr_bd_design_1 { parentCell } {
  ...
  # Create instance: Restr_axi_0, and set properties
  set Restr_axi_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:Restr_axi:1.0 Restr_axi_0 ]
...
SPI Flash#Quad SPI Flash#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0###GPIO1 MIO#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#USB0 Reset#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#GPIO1\
MIO#GPIO1 MIO#GPIO1 MIO#UART 0#UART 0#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#USB 0#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem 3#Gem\
3#Gem 3#Gem 3#Gem 3#Gem 3#MDIO 3#MDIO 3} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk#n_ss_out_upper#mo_upper[0]#mo_upper[1]#mo_upper[2]#mo_upper[3]#sclk_out_upper#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow###gpio1[26]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpio1[31]#reset#gpio1[33]#gpio1[34]#gpio1[35]#gpio1[36]#gpio1[37]#gpio1[38]#gpio1[39]#gpio1[40]#gpio1[41]#rxd#txd#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#gem3_mdc#gem3_mdio_out}\
\
...
\
  ...
  connect_bd_intf_net -intf_net Restr_axi_0_m_axi_DATA_IN [get_bd_intf_pins Restr_axi_0/m_axi_DATA_IN] [get_bd_intf_pins axi_smc/S00_AXI]
  connect_bd_intf_net -intf_net Restr_axi_0_m_axi_DATA_OUT [get_bd_intf_pins Restr_axi_0/m_axi_DATA_OUT] [get_bd_intf_pins axi_smc_1/S00_AXI]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins Restr_axi_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  connect_bd_net -net rst_ps8_0_96M_peripheral_aresetn [get_bd_pins Restr_axi_0/ap_rst_n] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_smc_1/aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_96M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins Restr_axi_0/ap_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_smc_1/aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_96M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/saxihp2_fpd_aclk]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_IN] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_IN] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_IN] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
  assign_bd_address -offset 0x000800000000 -range 0x000800000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_OUT] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_HIGH] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_OUT] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_OUT] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_QSPI] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs Restr_axi_0/s_axi_control/Reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_IN] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces Restr_axi_0/Data_m_axi_DATA_OUT] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP4/HP2_LPS_OCM]

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   "ActiveEmotionalView":"Default View",
   "Default View_ScaleFactor":"0.697059",
   "Default View_TopLeft":"0,-570",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.0r4  2019-12-20 bk=1.5203 VDI=41 GEI=36 GUI=JA:10.0 TLS
#  -string -flagsOSRD
preplace inst Restr_axi_0 -pg 1 -lvl 1 -x 220 -y -270 -defaultsOSRD
preplace inst rst_ps8_0_96M -pg 1 -lvl 3 -x 1260 -y -140 -defaultsOSRD
preplace inst axi_smc -pg 1 -lvl 4 -x 1630 -y -420 -defaultsOSRD
preplace inst axi_smc_1 -pg 1 -lvl 4 -x 1630 -y -260 -defaultsOSRD
preplace inst ps8_0_axi_periph -pg 1 -lvl 4 -x 1630 -y 20 -defaultsOSRD
preplace inst zynq_ultra_ps_e_0 -pg 1 -lvl 2 -x 750 -y -130 -defaultsOSRD
preplace netloc zynq_ultra_ps_e_0_pl_clk0 1 0 4 10 -130 420 -30 1070 -260 1460
preplace netloc zynq_ultra_ps_e_0_pl_resetn0 1 2 1 1080 -160n
preplace netloc rst_ps8_0_96M_peripheral_aresetn 1 0 4 30 -180 410J -250 NJ -250 1470
preplace netloc Restr_axi_0_m_axi_DATA_OUT 1 1 3 410J -280 NJ -280 N
preplace netloc zynq_ultra_ps_e_0_M_AXI_HPM0_LPD 1 2 2 1060J -40 N
preplace netloc ps8_0_axi_periph_M00_AXI 1 0 5 20 -190 420J -240 NJ -240 1440J -170 1780
preplace netloc axi_smc_1_M00_AXI 1 1 4 440 -270 NJ -270 1450J -180 1780
preplace netloc axi_smc_M00_AXI 1 1 4 430 -340 NJ -340 NJ -340 1780
preplace netloc Restr_axi_0_m_axi_DATA_IN 1 1 3 410J -350 NJ -350 1440
levelinfo -pg 1 -10 220 750 1260 1630 1800
pagesize -pg 1 -db -bbox -sgen -10 -500 1800 180
"
}
...
if { [get_property IS_LOCKED [ get_files -norecurse design_1.bd] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/project_Xray3D.gen/sources_1/bd/design_1/hdl/design_1_wrapper.v" ]
} else {
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xczu7ev-ffvc1156-2-i -flow {Vivado Synthesis 2020} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xczu7ev-ffvc1156-2-i -flow {Vivado Implementation 2020} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
